...
tr <- sim(subvcf, subcoords, lyr, stat = "pi", fact = 3, wdim = 5, min_n = 6, rarify = FALSE, parallel = TRUE)
...
note to self: I don't think I am counting total time right still...need to think on it
