...
# system time sims
```{r}
vcf <- read.vcfR("data/mod-sim_params_it-0_t-4000_spp-spp_0.vcf")
geo <- read.csv("data/mod-sim_params_it-0_t-4000_spp-spp_0.csv")
...
tr <- sim(subvcf, subcoords, lyr, stat = "pi", fact = 3, wdim = 5, rarify_n = 4, rarify_nit = 5, rarify = TRUE, parallel = TRUE, nloci = nrow(subvcf@gt))
