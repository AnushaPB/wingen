...
>>>>>>> 85a8ec4f95212fa728de953d32b95b7538024fdc
...
# FULL
```{r}
load("results_FULL_noRarify.RData")
fulldiv <- mask_gd(results[[2]], 10)

fulldiv <- results[[2]][[1]]
fulldiv[results[[2]][[2]] < 4] <- NA
plot(fulldiv, col = magma(100))
```
# COMPARE STATS
```{r}
set.seed(42)
