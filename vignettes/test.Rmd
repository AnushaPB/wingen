...
coordinate system or use an equal area projection such that raster cell 
width and height are equal. Therefore, longitude-latitude systems
...
```{r, fig.width = 5, fig.height = 5, cache = FALSE, warning = FALSE}
preview_gd(lotr_lyr,
  lotr_coords,
  wdim = 7,
  fact = 3,
...
```{r moving window, fig.width = 5, fig.height = 5, cache = FALSE, warning = FALSE}
...
```{r krige results, fig.width = 5, fig.height = 5, cache = FALSE, warning = FALSE}
...
```{r universal krige results, fig.width = 5, fig.height = 5, cache = FALSE, warning = FALSE}
...
# rescale lotr_lyr to sampe resolution as kgd before masking
mask_lyr <- disaggregate(rast(lotr_lyr), 2)
