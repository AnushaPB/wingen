...
window functions calculations with parallelization using the furrr
package. Checkout the [furrr package
documentation](https://furrr.futureverse.org/) for more details on using
parallelization.
