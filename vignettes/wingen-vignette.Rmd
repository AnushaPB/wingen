...
2. `coords` -  `sf` points or a matrix or dataframe with two columns representing the coordinates of the samples. The first column should be x (i.e., Longitude) and the second should be y (i.e., Latitude). 
...
mgd <- mask_gd(kgd_autoKrige[["raster"]], kgd_autoKrige[["stdev"]], maxval = 0.05)
