...
# The simulated coordinates are not projected, but for the purpose of this example we pretend they are projected under the Goode Homolosine projection, but this should not be done for real data (see above example for how to properly project coordinates)
