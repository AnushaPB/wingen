...
You can also create ggplots of your results using `ggplot_gd()` and
`ggplot_count()`
...
```{r mask results 3, fig.width = 5, fig.height = 5, eval = FALSE}
...
for more details on setting up the backend for parallelization.
