...
a standard file type to encode genomic data, a user's input data can be
converted quite easily such that wingen can be run.
...
The `genomic_converter()` function within the radiator package
(available on Github
...
*Note:* Keep in mind that in some cases, microsatellite data may not be
...
# You can verify the file type of your input data if you wish:
