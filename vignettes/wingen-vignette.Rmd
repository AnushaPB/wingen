...
In addition to pi, users can calculate observed heterozygosity (`"Ho"`), allelic richness (either using `"biallelic.richness"` [faster but only works on biallelic data] or `"allelic.richness"`):
