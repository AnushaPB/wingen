...
par(pty = "s")
# The plot_gd function plots the genetic diversity layer
plot_gd(cgd, main = "Circle moving window pi")
# The plot_count function plots the sample count layer
...
2.  `cond_lyr` - conductivity layer used to calculate resistance distances
...
par(pty = "s")
# The plot_gd function plots the genetic diversity layer
plot_gd(rgd, main = "Resistance moving window pi")
# The plot_count function plots the sample count layer
