...
*Note:* by default, the kriging method is set to `krig_method = "ordinary"` for ordinary/simple kriging (model formula: ~ 1). Alternatively, `krig_method` can be set to `"universal"` for universal kriging (model formula: ~ x + y).
...
kgd_universal <- krig_gd(wgd, index = 1:2, lotr_lyr, disagg_grd = 2, krig_method = "universal")
