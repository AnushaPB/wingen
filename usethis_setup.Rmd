...
usethis::use_build_ignore("token.R")

usethis::use_build_ignore(".gitignore")

usethis::use_build_ignore(".github")

usethis::use_build_ignore("git_token.R")
...
## Figshare token
```{r}
Sys.setenv ("FIGSHARE_TOKEN" = "f7919f53ed5227c55356335accb321e9c955be8ffe6049ace76b02973e13aeae0d79a630ed148ded4ca2d850dd9a66f874ccf8a3f2c9933b60d42e3d7412f300")

cli <- depositsClient$new(service = "figshare")
cli$deposit_download_file(20459376, filename = "simulation_example_csv.csv")
cli$deposits
