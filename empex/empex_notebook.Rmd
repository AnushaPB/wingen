...
states <- rgdal::readOGR("TIGRIS_USA/cb_2018_us_state_5m.shp")
...
system.time(kpg <- krig_gd(pg[[1]], lyr, disagg_grd = 4))
mpg <- mask(kpg, PNW)

system.time(kag <- krig_gd(ag[[1]], lyr, disagg_grd = 4))
mag <- mask(kag, PNW)

system.time(khg <- krig_gd(hg[[1]], lyr, disagg_grd = 4))
mhg <- mask(khg, PNW)

```

```{r}
system.time(ksc <- krig_gd(pg[[2]], lyr, agg_r = 4, disagg_grd = 4))
plot_count(ksc, breaks = 100)
mpg <- mask_gd(kpg, ksc, minval = 1)

plot_count(ksc, breaks = 10)
plot_gd(mpg, PNW)
```
...
pgn <- window_gd(vcf, coords, lyr, stat = "pi", wdim = w, fact = f, rarify = FALSE, min_n = 2)

agn <- window_gd(vcf, coords, lyr, stat = "biallelic.richness", wdim = w, fact = f, min_n = 2)
...
plot_gd(pg, PNW, legend.width = 2, axis.args = list(cex.axis = 2))
plot_gd(ag, PNW, legend.width = 2, axis.args = list(cex.axis = 2))
plot_gd(hg, PNW, legend.width = 2, axis.args = list(cex.axis = 2))

plot_gd(pgn, PNW, legend.width = 2, axis.args = list(cex.axis = 2))
plot_gd(agn, PNW, legend.width = 2, axis.args = list(cex.axis = 2))
plot_gd(hgn, PNW, legend.width = 2, axis.args = list(cex.axis = 2))
...
plot_gd(pg, PNW, zlim = get_minmax(pg, pgn), legend.width = 2, axis.args = list(cex.axis = 2))
plot_gd(ag, PNW, zlim = get_minmax(ag, agn), legend.width = 2, axis.args = list(cex.axis = 2))
plot_gd(hg, PNW, zlim = get_minmax(hg, hgn), legend.width = 2, axis.args = list(cex.axis = 2))

plot_gd(pgn, PNW, zlim = get_minmax(pg, pgn), legend.width = 2, axis.args = list(cex.axis = 2))
plot_gd(agn, PNW, zlim = get_minmax(ag, agn), legend.width = 2, axis.args = list(cex.axis = 2))
plot_gd(hgn, PNW, zlim = get_minmax(hg, hgn), legend.width = 2, axis.args = list(cex.axis = 2))
