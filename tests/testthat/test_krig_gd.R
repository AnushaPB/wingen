...
test_that("raster_transform transformations are correct", {
  ...
  expect_equal(terra::values(noTransform[[1]], r))
  expect_equal(terra::values(noTransform[[2]], grd))
  ...
  expect_equal(terra::values(resample_r[[1]], terra::rast(grd)))
  expect_equal(terra::values(resample_r[[2]], terra::rast(grd)))
  ...
  expect_equal(terra::values(agg_r[[1]], raster::aggregate(r, 2)))
  expect_equal(terra::values(agg_r[[2]], grd))
  ...
  expect_equal(terra::values(disagg_r[[1]], terra::disagg(r, 2)))
  expect_equal(terra::values(disagg_r[[2]], grd))
  ...
  expect_equal(terra::values(resample_grd[[1]], terra::rast(r)))
  expect_equal(terra::values(resample_grd[[2]], terra::rast(r)))
  ...
  expect_equal(terra::values(agg_grd[[1]], r))
  expect_equal(terra::values(agg_grd[[2]], terra::aggregate(grd, 2)))
  ...
  expect_equal(terra::values(disagg_grd[[1]], r))
  expect_equal(terra::values(disagg_grd[[2]], terra::disagg(grd, 2)))
