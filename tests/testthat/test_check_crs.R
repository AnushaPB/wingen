...
test_that("CRS are handled correctly by window_gd", {
  ...
  expect_equal(cw[1], "No CRS found for the provided coordinates. Make sure the coordinates and the raster have the same projection. Assuming euclidean coordinates.")
  expect_equal(cw[2], "No CRS found for the provided raster. Make sure the coordinates and the raster have the same projection.")

  # no CRS lyr and CRS coords
  expect_warning(window_gd(mini_vcf, crs_coords, nocrs_lyr, rarify = FALSE), "No CRS found for the provided raster. Make sure the coordinates and the raster have the same projection.")

  # CRS lyr and no CRS coords
  expect_warning(window_gd(mini_vcf, nocrs_coords, crs_lyr, rarify = FALSE), "No CRS found for the provided coordinates. Make sure the coordinates and the raster have the same projection. Assuming euclidean coordinates.")
...
test_that("CRS are handled correctly by krig_gd (coords vs r)", {
  ...
  expect_equal(cw[1], "No CRS found for the provided raster (r). Make sure that r and coords have the same projection.")
  expect_equal(cw[2], "No CRS found for the provided coordinates. Make sure the coordinates and the rasters have the same projection. Assuming euclidean coordinates.")
  ...
  expect_equal(cw[1], "No CRS found for the provided coordinates. Make sure the coordinates and the rasters have the same projection. Assuming euclidean coordinates.")
...
test_that("CRS are handled correctly by krig_gd (r vs grd)", {
  ...
  expect_equal(cw[1], "No CRS found for the provided raster (r). Make sure that r and grd have the same projection.")
  expect_equal(cw[2], "No CRS found for the provided raster (grd). Make sure that r and grd have the same projection.")
  ...
  expect_equal(cw[1], "No CRS found for the provided raster (grd). Make sure that r and grd have the same projection.")
