...
#' plot_gd(mini_lyr)
#'
plot_gd <- function(x, bkg = NULL, index = NULL, col = viridis::magma(breaks), breaks = 100, main = NULL, box = FALSE, ...) {
...
#' @export
#' @noRd
plot_gd_bkg <- function(index, x, bkg = NULL, col = viridis::magma(breaks), breaks = 100, main = NULL, box = FALSE, ...) {
...
#' data("mini_lyr")
#' plot_count(mini_lyr)
plot_count <- function(x, index = NULL, breaks = 100, col = viridis::mako(breaks), main = NULL, box = FALSE, ...) {
