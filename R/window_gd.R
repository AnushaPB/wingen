...
#' @param parallel whether to parallelize the function (defaults to FALSE; **deprecated as of 2.1.0: furrr::plan() should be used to setup parallelization instead (see package vignette)**)
#' @param ncores if parallel = TRUE, number of cores to use for parallelization (defaults to total available number of cores minus 1; **deprecated as of 2.1.0: furrr::plan() should be used to setup parallelization instead (see package vignette)**)
