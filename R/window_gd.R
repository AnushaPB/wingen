...
#' @param stat genetic diversity statistic to calculate (can either be `"pi"` for nucleotide diversity (default), `"Ho"` for average observed heterozygosity across all sites,
#' `"allelic_richness"` for average number of alleles across all sites, `"biallelic_richness"` to get average allelic richness across all sites for a biallelic dataset (this option faster than `"allelic_richness"`))
...
#'
#' @return heterozygosity averaged across all loci
#'
#' @noRd
