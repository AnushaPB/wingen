...
*As of 06/30/2025, wingen has been archived on CRAN because it depended on the now-archived
automap package. We are working on resolving this issue. Wingen can
still be installed from GitHub and automap can be installed from the
CRAN archive:
