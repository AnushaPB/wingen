...
```{r mask_gd, warning = FALSE, message = FALSE, cache = TRUE, results = FALSE}
...
A pdf of the vignette can also be found [here](https://github.com/AnushaPB/wingen/blob/dev/vignettes/wingen-vignette.pdf)
