...
```{r window_gd, warning = FALSE, message = FALSE, cache = TRUE, results = FALSE, fig.height = 4, fig.width = 4.5}
...
```{r result, warning = FALSE, message = FALSE, cache = TRUE, results = FALSE, fig.height = 4, fig.width = 4.5}
# Plot results
ggplot_gd(kgd) +
  ggtitle("Kriged pi")
