...
The following example demonstrates the basic functionality of `wingen` using a subset of the simulated data from Bishop et al. (202X). For more details about this data set check out the [original paper](LINK) and the package vignette.
...
Finally, the output from `krige_gd` (or `window_gd`) can be masked to exclude areas that fall outside of the study area or that were undersampled. 
