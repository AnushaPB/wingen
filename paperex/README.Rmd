---
title: "Examples from Bishop et al. (2023)"
...
These analyses were run using wingen v1.0.0 which can be downloaded from Zenodo:
...
PDF versions of figures from Bishop et al. (2023) are provided in the `figures` directory. 
