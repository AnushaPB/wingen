...
pdf(here(wdir, "plots", "figure_2.1.pdf"))
...
pdf(here(wdir, "plots", "figure_2.2.pdf"))
par(mar = rep(2,4), oma = rep(3,4))
...
pdf(here(wdir, "plots", "figure_2.3.pdf"))
...
pdf(here(wdir, "plots", "figure_2.4.pdf"))
plot_gd(wg, bkg, zlim = c(0, 0.31), legend = FALSE)
dev.off()

pdf(here(wdir, "plots", "figure_2.5.pdf"))
plot_count(wg, zlim = c(0,30), legend = FALSE)
dev.off()

pdf(here(wdir, "plots", "figure_2.6.pdf"))
plot_gd(kg, zlim = c(0, 0.31), breaks = 20, legend = FALSE)
dev.off()

pdf(here(wdir, "plots", "figure_2.7.pdf"))
plot_count(kc, zlim = c(0,30), legend = FALSE)
dev.off()

pdf(here(wdir, "plots", "figure_2.8.pdf"))
plot_gd(mg, bkg,zlim = c(0, 0.31), breaks = 20, legend = FALSE)
dev.off()

pdf(here(wdir, "plots", "figure_2.9.pdf"))
par(oma = rep(2,4))
plot_gd(kg, zlim = c(0, 0.31), breaks = 20, axis.args = list(cex.axis = 1.75), legend.shrink = 0.7, legend.width = 1.5, legend.only = TRUE)
dev.off()


pdf(here(wdir, "plots", "figure_2.10.pdf"))
par(mar = rep(1,4))
plot_count(kc, zlim = c(0,30), horizontal = TRUE, axis.args = list(cex.axis = 2), legend.shrink = 0.3, legend.width = 1, legend.only = TRUE)
dev.off()
```
...
pdf(here(wdir, "plots", "figure_3.1.pdf"), width = 6.75, height = 4.5)
par(mfrow = c(2, 3), mar = c(1, 0, 1, 0), oma = rep(0, 4))
purrr::walk(stk200, test_simex_plot, legend = FALSE)
dev.off()

pdf(here(wdir, "plots", "figure_3.2.pdf"))
par(oma = rep(1,4))
plot_gd(stk200[[1]], zlim = c(0, 0.31), breaks = 100, legend.only = TRUE, 
        legend.width = 2, legend.shrink = 0.75, axis.args = list(cex.axis = 2))
dev.off()
pdf(here(wdir, "plots", "figure_3.3.pdf"))
par(oma = rep(1,4))
plot_gd(stk200[[1]], zlim = c(1, 1.95), breaks = 100, legend.only = TRUE, 
        legend.width = 2, legend.shrink = 0.75, axis.args = list(cex.axis = 2))
dev.off()
pdf(here(wdir, "plots", "figure_3.4.pdf"))
par(oma = rep(1,4))
plot_gd(stk200[[1]], zlim = c(0, 0.29), breaks = 100, legend.only = TRUE, 
        legend.width = 2, legend.shrink = 0.75, axis.args = list(cex.axis = 2))
dev.off()
```
