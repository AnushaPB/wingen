...
tr <- sim(subvcf, subcoords, lyr, stat = "het", wdim = 3, fact = 3, rarify_n = 2, rarify_nit = 5, rarify = FALSE, parallel = TRUE, L = nrow(subvcf@gt))
...
nr <- window_gd(subvcf, subcoords[,c("x","y")], lyr, "biallelic.richness", wdim = 5, fact = 3, rarify = FALSE, min_n = 4, L = nrow(subvcf@gt))
yr <- window_gd(subvcf, subcoords[,c("x","y")], lyr, "biallelic.richness", wdim = 5, fact = 3,rarify = TRUE, rarify_n = 4, rarify_nit = 5, L = nrow(subvcf@gt))
par(mfrow = c(1,3))
