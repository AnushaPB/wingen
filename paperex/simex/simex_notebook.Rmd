...
```
```{r}
br <- window_gd(subvcf, subcoords, lyr, stat = "biallelic.richness", rarify = TRUE, wdim = 3, fact = 3, rarify_n = 2, rarify_nit = 5, parallel = FALSE, rarify_alleles = TRUE)

bra <- window_gd(subvcf, subcoords, lyr, stat = "biallelic.richness",  rarify = TRUE, wdim = 3, fact = 3, rarify_n = 2, rarify_nit = 5, rarify_alleles = FALSE)

plot_gd(br)

ml <- get_divout(file.name = "rr", rarify = TRUE, stat = "biallelic.richness", nsamp = 200)
plot_gd(ml)
