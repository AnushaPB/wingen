---
title: "Simulation Example from Bishop et al. (submitted)"
...
purrr::walk(stk100, test_simex_plot, legend = FALSE, polyx = 102, polyy = -102)

par(mfrow = c(2, 3), mar = c(1, 0, 1, 0), oma = rep(0, 4))
purrr::walk(stk200, test_simex_plot, legend = TRUE, polyx = 102, polyy = -102)
