...
purrr::walk(stk, test_empex_plot, bkg = NUS_longlat, zlim = c(0.02, 0.11))


par(oma = rep(2,4))
raster_plot_gd(stk[[1]], zlim = c(0.02, 0.11), breaks = 100, legend.only = TRUE, 
...
raster_plot_gd(mpg, legend = FALSE)
plot(NUS_longlat, add = TRUE, col = NA, border = "white", lwd = 3)
points(coords, pch = 16, col = mako(1, begin = 0.8), cex = 2.1)
raster_plot_gd(mpg, smallplot = c(0.0, .02, .2,.75), legend.width = 2, legend.shrink = 0.1, axis.args = list(cex.axis = 3), legend.only = TRUE, add = TRUE)

raster_plot_gd(mag, legend = FALSE)
plot(NUS_longlat, add = TRUE, col = NA, border = "white", lwd = 3)
points(coords, pch = 16, col = mako(1, begin = 0.8), cex = 2.1)
raster_plot_gd(mag, smallplot = c(0.0, .02, .2,.75), legend.width = 2, legend.shrink = 0.1, axis.args = list(cex.axis = 3), legend.only = TRUE, add = TRUE)

raster_plot_gd(mhg, legend = FALSE)
plot(NUS_longlat, add = TRUE, col = NA, border = "white", lwd = 3)
points(coords, pch = 16, col = mako(1, begin = 0.8), cex = 2.1)
raster_plot_gd(mhg, smallplot = c(0.0, .02, .2,.75), legend.width = 2,legend.shrink = 0.1, axis.args = list(cex.axis = 3), legend.only = TRUE, add = TRUE)
dev.off()
...
raster_plot_gd(pg, NUS_longlat, breaks = 100, legend.width = 2, axis.args = list(cex.axis = 2))
raster_plot_gd(ag, NUS_longlat, breaks = 100, legend.width = 2, axis.args = list(cex.axis = 2))
raster_plot_gd(hg, NUS_longlat, breaks = 100, legend.width = 2, axis.args = list(cex.axis = 2))

raster_plot_gd(pgn, NUS_longlat, breaks = 100, legend.width = 2, axis.args = list(cex.axis = 2))
raster_plot_gd(agn, NUS_longlat, breaks = 100, legend.width = 2, axis.args = list(cex.axis = 2))
raster_plot_gd(hgn, NUS_longlat, breaks = 100, legend.width = 2, axis.args = list(cex.axis = 2))

par(mfrow = c(2, 3), mar = rep(1,4), oma = rep(3,4))

raster_plot_gd(pg, NUS_longlat, breaks = 100, zlim = get_minmax(pg, pgn), legend.width = 2, axis.args = list(cex.axis = 2))
raster_plot_gd(ag, NUS_longlat, breaks = 100, zlim = get_minmax(ag, agn), legend.width = 2, axis.args = list(cex.axis = 2))
raster_plot_gd(hg, NUS_longlat, breaks = 100, zlim = get_minmax(hg, hgn), legend.width = 2, axis.args = list(cex.axis = 2))

raster_plot_gd(pgn, NUS_longlat, breaks = 100, zlim = get_minmax(pg, pgn), legend.width = 2, axis.args = list(cex.axis = 2))
raster_plot_gd(agn, NUS_longlat, breaks = 100, zlim = get_minmax(ag, agn), legend.width = 2, axis.args = list(cex.axis = 2))
raster_plot_gd(hgn, NUS_longlat, breaks = 100, zlim = get_minmax(hg, hgn), legend.width = 2, axis.args = list(cex.axis = 2))
```
