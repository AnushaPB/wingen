...
set.seed(22)
system.time(ag1 <- window_gd(vcf, coords, lyr, stat = "biallelic.richness", wdim = wdim, fact = fact, rarify = TRUE, rarify_n = 2, rarify_nit = 5, parallel = TRUE, ncores = 5, rarify_alleles = TRUE))

set.seed(22)
system.time(ag2 <- window_gd(vcf, coords, lyr, stat = "allelic.richness", wdim = wdim, fact = fact, rarify = TRUE, rarify_n = 2, rarify_nit = 5, parallel = TRUE, ncores = 5))
...
plot_gd(ag, NUS, breaks = 100, zlim = get_minmax(ag, bag), main = "allelic.richness")
plot_gd(bag, NUS, breaks = 100, zlim = get_minmax(ag, bag), main = "biallelic.richness")


par(mfrow = c(1,2), mar = rep(1,4), oma = rep(2,4))
plot_gd(ag, NUS, breaks = 100, main = "allelic.richness")
plot_gd(bag, NUS, breaks = 100, main = "biallelic.richness")
```
